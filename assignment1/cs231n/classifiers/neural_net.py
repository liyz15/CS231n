...
class TwoLayerNet(object):
  ...
  def train(self, X, y, X_val, y_val,
    ...
    for it in xrange(num_iters):
      ...
      #########################################################################
      ind = np.random.choice(np.arange(num_train), size=batch_size, replace=True)
      X_batch = X[ind]
      y_batch = y[ind]
      #########################################################################
      #                             END OF YOUR CODE                          #
      ...
      # print(learning_rate * grads['b2'])

      # print(np.sqrt(np.sum(np.square(grads['W1']))))
      #########################################################################
      #                             END OF YOUR CODE                          #
      #########################################################################

      if verbose and it % 100 == 0:
        print('iteration %d / %d: loss: %f lr: %f' % (it, num_iters, loss, learning_rate))
  ...
  def predict(self, X):
    ...
    y_pred = X.dot(W1) + b1
    y_pred[y_pred <= 0] = 0.0
    y_pred = np.argmax(y_pred.dot(W2) + b2, axis=1)
    ###########################################################################
    #                              END OF YOUR CODE                           #
    ###########################################################################
